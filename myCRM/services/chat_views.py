...
def execute_suggestion(request):
    """
    使用者按下「執行此建議」:
      → 呼叫 save_final_suggestion
      → 寫入 ai_suggection + 若有券則寫入 campaign
    """
    ...
    return JsonResponse({"status": "ok", "suggestID": suggest_id})
